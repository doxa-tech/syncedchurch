class MembersController < ApplicationController
  ...
  def member_params
    params.require(:member).permit(:adress, :npa, :city, :job, :email, :extra, :firstname, :lastname, :gender, :birthday, :role, family_attributes: [:lastname], phones_attributes: [:phone_type, :number, :private,:_destroy], private: [])
  end
